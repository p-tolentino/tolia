  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-muted/30 px-4">
      <div className="w-full max-w-sm space-y-6">
        ...
        {showFirstTime ? (
          <form
            onSubmit={firstTimeForm.handleSubmit(onFirstTime)}
            className="space-y-4"
          >
            <Field
              data-invalid={!!firstTimeForm.formState.errors.agentCode}
            >
              <FieldLabel htmlFor="agentCode">Agent Code</FieldLabel>
              <Input
                id="agentCode"
                {...firstTimeForm.register("agentCode", {
                  required: "Agent code is required",
                })}
                aria-invalid={!!firstTimeForm.formState.errors.agentCode}
                placeholder="e.g. 71234567"
                autoCapitalize="none"
                autoCorrect="off"
              />
              {firstTimeForm.formState.errors.agentCode && (
                <FieldError
                  errors={[firstTimeForm.formState.errors.agentCode]}
                />
              )}
            </Field>
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid}>
                  <FieldLabel htmlFor={field.name}>Agent Code</FieldLabel>
                  <Input
                    {...field}
                    id={field.name}
